		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Display Table and List from Back-end ODATA service Data",
									"targetURL": "#r6tableandlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"r6tableandlist-display": {
								"semanticObject": "r6tableandlist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=r6tableandlist",
									"url": sap.ui.require.toUrl("r6tableandlist")
								}
							}
						}
					}
